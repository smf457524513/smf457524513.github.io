...
<div style="display: flex; align-items: center; gap: 20px;">
  ...
  <div style="flex: 1;">
    <img src="assets/research_model_cropped.pdf" alt=" Modeling & Simulation in Mixed Autonomy Traffic" style="max-width:100%; border-radius:8px; box-shadow: 0 2px 6px rgba(0,0,0,0.1);" />
  </div>
...
<div style="display: flex; align-items: center; gap: 20px;">
  ...
  <div style="flex: 1;">
    <img src="assets/research_control_cropped.pdf" alt="Infrastructure Control" style="max-width:100%; border-radius:8px; box-shadow: 0 2px 6px rgba(0,0,0,0.1);" />
  </div>
